...
const searchExamples = [
  ...
  {
    label: 'breast cancer genes',
    terms: ['BRCA1', 'BRCA2', 'PALB2', 'CHEK2'],
    taxon: '9606',
    type: 'gene',
  },
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-x-8 xl:gap-y-20 lg:gap-y-2">
          <div className="relative mx-auto max-w-2xl lg:col-span-7 lg:max-w-none lg:pt-6 xl:col-span-6">
            ...
            <p className="mt-6 text-lg text-gray-600">
              Finding the perfect tool to search or create biological network figures has never been
              easier. Whether you are exploring genes, proteins or pathways, our intuitive interface
              allows you to analyze your data and create beautiful figures that are ready to be
              published.
            </p>
            <div className="mt-10 flex flex-col gap-y-0 sm:items-start xs:items-start">
              <label className="mb-1 text-base/7 font-semibold text-gray-900">Try it now:</label>
              <SearchBar
            ...
            <div className="mt-16 text-center">
              <button
                onClick={() =>
                  window.scrollTo({
                    top: document.getElementById('genes').offsetTop,
                    behavior: 'smooth',
                  })
                }
