...
const SearchField = ({ placeholder }) => (
  <div className="relative w-full mt-2 rounded-md shadow-sm">
    ...
    <button className="absolute inset-y-0.5 right-0.5 w-8 h-8 flex items-center justify-center rounded-2xl hover:bg-gray-100 active:bg-gray-200">
      <MagnifyingGlassIcon className="h-5 w-5 fill-complement-500" aria-hidden="true" />
    </button>
  </div>
);
...
const features = [
  ...
  },
  {
    ...
    form: (
      <div className="flex w-full justify-center">
        <LinkButton href="https://enrichmentmap.org/">Go to EnrichmentMap</LinkButton>
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    form: (
      <div className="flex w-full justify-center">
        <LinkButton href="https://web.cytoscape.org/">Go to Cytoscape Web</LinkButton>
      </div>
    ),
  },
  {
    ...
    description: (
      <>
        Open source{' '}
        <Link href="https://cytoscape.org/download.html" ariaLabel="Download Cytoscape">
          software
        </Link>{' '}
        platform for visualizing complex networks.
        <br />
        Customize it through the use of{' '}
        <Link href="https://apps.cytoscape.org/" ariaLabel="Cytoscape App Store">
          app extensions
        </Link>
        .<br />
        Use{' '}
        <Link href="https://doi.org/10.12688/f1000research.6767.1" ariaLabel="cyREST paper">
          cyREST
        </Link>{' '}
