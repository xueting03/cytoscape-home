        ...
        <div className="px-4 py-2">
          <svg x="0" y="0" width="95%" viewBox="0, 0, 300, 300">
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 270.725, 114.045)">
              <tspan x="-12.502" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                MSH2
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 207.19, 137.061)">
              <tspan x="-12.004" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                MLH1
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 101.292, 66.004)">
              <tspan x="-14.177" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                SPO11
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 91.291, 137.944)">
              <tspan x="-12.751" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                DMC1
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 187.011, 240.534)">
              <tspan x="-14.506" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                RAD51
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 115.455, 235.28)">
              <tspan x="-15.005" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                BRCA2
              </tspan>
            </text>
            <path
            ...
            <text transform="matrix(1.124, 0, 0, 1.124, 148.791, 98.518)">
              <tspan x="-14.673" y="2.5" fontFamily="Helvetica" fontSize="9" fill="#2079a9">
                MRE11
              </tspan>
            </text>
          </svg>
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Cytoscape Home will guide you through the process of transforming your raw data into
            interactive networks. Use our tools to analyze the results, share them with
            collaborators and finally publish them.
          </p>
        </div>
      </Container>
