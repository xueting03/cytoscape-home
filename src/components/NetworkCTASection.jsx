...
const features = [
  {
    ...
    description:
      'Turn your network data into an editable visualization.  Drag and drop, zoom and pan, and style your network with ease.  Export to publication-quality PDFs.',
  ...
  },
  {
    ...
    description:
      'Run clustering analysis on your network to find modules.  Visualize the results with fitting layouts and styles.',
  ...
  },
  {
    ...
    description:
      'Run clustering analysis on your network to find sets of nodes with similar attributes.  Visualize the results with fitting layouts and styles.',
    icon: CpuChipIcon,
    tool: 'Cytoscape Web',
    toolLink: 'https://web.cytoscape.org/',
    tutorialLink: 'https://wikipedia.org',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:gap-y-20 lg:mx-0 lg:max-w-none lg:grid-cols-5">
          <div className="col-span-2">
            ...
            <p className="mt-6 text-base/7 text-gray-700">{description}</p>
          </div>
            ...
            {features.map(feature => (
              <div key={feature.name} className="relative pl-9">
                <dt className="font-semibold text-gray-900">
                  <feature.icon
                    aria-hidden="true"
                    className="absolute top-1 left-0 size-5 text-primary-500"
                  />
                  {feature.name}
                </dt>
                ...
                <dd className="mt-2 flex items-center">
                  ...
                  <HoverPopover content={<span>This is where a screenshot would go.</span>}>
                    <a href={feature.toolLink} target="_blank">
                      <Button color="secondary" className="ml-1">
                        <span className="text-center font-normal underline">
                          Or use {feature.tool}
                        </span>
                      </Button>
                    </a>
