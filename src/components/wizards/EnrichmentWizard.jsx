...
function EMPanel() {
  return (
    <div className="text-gray-600">
      <img
        src="/images/apps/em-web.png"
        alt="EnrichmentMap"
        className="w-fit mx-auto border-4 rounded-lg"
      />
      <p className="mt-5">
        Use EnrichmentMap to perform a gene set enrichment analysis and then visualize the results
        as a network.
      </p>
    </div>
  );
